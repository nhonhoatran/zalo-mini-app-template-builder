...
import { SAMPLE_PRIVACY_POLICY } from "./sample-data";
...
export const privacyPolicySchema = z.object({
  appName: z.string().default("Zalo Mini App"),
  contactEmail: z.string().email("Email liên hệ không hợp lệ").default("hotro@domain.com"),
  updatedAt: z.string().default("2026-07-27"),
});

export const privacyPolicyManifest: BlockManifest<PrivacyPolicyProps> = {
  type: "privacy-policy",
  label: "Chính sách bảo mật",
  icon: "zi-shield-check",
  category: "bat-buoc",
  propsSchema: privacyPolicySchema,
  defaultProps: SAMPLE_PRIVACY_POLICY,
  permissions: [],
  dependencies: {
    "zmp-ui": "^1.0.0",
  },
  usesSampleData: (props) => props.contactEmail === SAMPLE_PRIVACY_POLICY.contactEmail,
